...
heuristic_each_map = [10000,8,10000,15,9] # e is more around 9-14...
...
#        print("int(len(all_tags[position_photo_right])/2) = ", int(len(all_tags[position_photo_right])/2))
        ...
        if current_heurisitc_score_bien < max_current_score:
...
if use_sorted:
    write_output(vrai_solution_final , "/home/toromanoff/workspace/hashcode_1/data/"+name_file_input+"sortednew"+str(initial_heurisitc_score_bien)+".out")
else:
    write_output(vrai_solution_final , "/home/toromanoff/workspace/hashcode_1/data/"+name_file_input+"new.out")
